...
import com.unicampania.ccwebapp.model.model_aclass.AcoApplicationNotes;
...
public interface AcoApplicationNotesRepository extends JpaRepository<AcoApplicationNotes, String> {

    /*
    Select all from acoapplicationnotes where idf = id
    idf is foreign key for afamily
     */
    @Query(value ="select * from acoapplicationnotes where idf = :id",
            nativeQuery = true)
    /*
     ...
     */
    List<AcoApplicationNotes> AcoApplicationNotesInAComponent(@Param("id") String id);
