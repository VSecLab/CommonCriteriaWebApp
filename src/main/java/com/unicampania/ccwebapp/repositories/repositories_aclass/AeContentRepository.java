...
import com.unicampania.ccwebapp.model.model_aclass.AeContent;
...
public interface AeContentRepository extends JpaRepository<AeContent, String> {

    /*
Select all from aecontent where id_acomponent = id
id_acomponent is a foreign key for acomponent
 */
    @Query(value ="select * from aecontent where id_acomponent = :id",
            nativeQuery = true)
    /*
     ...
     */
    List<AeContent> AeContentInAComponent(@Param("id") String id);
